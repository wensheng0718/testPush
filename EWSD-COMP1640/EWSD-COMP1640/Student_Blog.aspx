<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student_Blog.aspx.cs" Inherits="EWSD_COMP1640.Student_Blog" %>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a style="background-color: mediumblue; color: white" href="Student_Blog.aspx">Blog</a></li>
                    </ul>
            ...
            <table class="auto-style1">
                <tr>
                    <td class="auto-style2">
                        <asp:Panel ID="Panel1" runat="server" Height="600px" ScrollBars="Vertical" Width="266px">
                            <asp:DataList ID="DataList1" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" GridLines="Both" Style="text-align: right" OnItemCommand="DataList1_ItemCommand1" Height="291px" Width="211px">
                                ...
                                <ItemTemplate>
                                    ...
                                    <br />
                                    <asp:Label ID="lbl_publisher" runat="server" Text='<%# Eval("Post_Name") %>'></asp:Label>
                                    <br />
                                    <br />
                                    Time Date:
                    ...
                    <td class="auto-style6">
                        <asp:Panel ID="Panel2" runat="server" Height="600px" Width="744px">
                            <asp:DataList ID="DataList2" runat="server" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" Height="175px" OnItemCommand="DataList2_ItemCommand" Width="356px">
                                <AlternatingItemStyle BackColor="#F7F7F7" />
                                <EditItemTemplate>
                                    Message :<asp:TextBox ID="txt_msg" Text='<%# Eval("message") %>' runat="server" Height="41px" Width="212px"></asp:TextBox>
                                    <br />
                                    <br />
                                    <asp:Label ID="lbl_idb" runat="server" Text='<%# Eval("id") %>' Visible="true"></asp:Label>
                                    <br />
                                    <br />
                                    <br />
                                    <asp:ImageButton ID="ImageButton2" runat="server" CommandName="edit" Height="37px" ImageUrl="~/images/btn_confirm.png" Width="43px" CausesValidation="False" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:ImageButton ID="ImageButton4" CommandName="go_back" runat="server" Height="37px" ImageUrl="~/images/unnamed.png" Width="38px" CausesValidation="False" />
                                </EditItemTemplate>
                            ...
                            <br />
                            &nbsp;
                            <asp:Label ID="lbltimedate" runat="server"></asp:Label>
                            <asp:Label ID="lbl_status" runat="server"></asp:Label>
                            <br />
                            <table class="auto-style4">
                                <tr>
                                    <td class="auto-style5">Title:
                                        <asp:TextBox ID="txt_title" runat="server" Height="22px" MaxLength="50" Width="353px"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"  ForeColor="Red" ControlToValidate="txt_title" ErrorMessage="Title Required"></asp:RequiredFieldValidator>
                                        <asp:FileUpload ID="file_uploadblog" runat="server" />
                                    </td>
                                </tr>
                                <tr>
