<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tutor_Profile.aspx.cs" Inherits="EWSD_COMP1640.Tutor_Profile" %>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a style="background-color: mediumblue; color: white" href="Tutor_Profile.aspx">Profile</a></li>
                        ...
                        <table border="1" style="width: 800px;">
                            <tr style="height: 30px">
                                <td colspan="2" class="title">
                                    <asp:Label ID="Label5" runat="server" Text="Tutor Details"></asp:Label>
                                </td>
                            ...
                            <tr style="height: 30px">
                                ...
                                <td>
                                    ...
                                    <asp:Label ID="Label3" runat="server" Text=' <%# Eval("Tutor_Id") %>'></asp:Label>
                                </td>
                            </tr>
                            ...
                            <tr style="height: 30px">
                                ...
                                <td>
                                    ...
                                    <asp:Label ID="lbl_name" runat="server" Text=' <%# Eval("Tutor_Name") %>'></asp:Label>
                                </td>
                            </tr>
