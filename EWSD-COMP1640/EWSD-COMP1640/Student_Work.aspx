<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student_Work.aspx.cs" Inherits="EWSD_COMP1640.Student_Work" %>
            ...
            <asp:GridView ID="GridView3" AutoGenerateColumns="False" runat="server" DataKeyNames="Work_Code"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Upload">
                        <ItemStyle Width="200" Height="30" />
                        <ItemTemplate>
                            <asp:Button ID="btn_upload" runat="server" Text="Upload" CommandName="upload" CommandArgument='<%# Container.DataItemIndex %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
