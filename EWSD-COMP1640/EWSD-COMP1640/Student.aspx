<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="EWSD_COMP1640.Home" %>
        ...
        <fieldset>
            <form id="form1" runat="server">
                ...
                <div>
                    ...
                    <br />
                    <asp:TextBox ID="txtsearch" runat="server" placeholder="Student ID"></asp:TextBox>
                    &nbsp;
             <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="Course" DataValueField="Course" AppendDataBoundItems="true">
                 ...
                 <asp:ListItem Value="1">All</asp:ListItem>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT DISTINCT[Course] FROM [Student]"></asp:SqlDataSource>
                    <asp:Button ID="btn_search" runat="server" Text="Search" OnClick="btn_search_Click" />
                </div>
              
                <div>
                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged" AutoPostBack="True" CellSpacing="2" CellPadding="3" Width="300px">
                ...
                <div class="main2" style="text-align: center;">
                    <asp:Button ID="Btn_assign" runat="server" Text="Assign Tutor" OnClick="Btn_assign_Click" BackColor="Yellow" Font-Bold="True" Font-Size="Medium" />
                    <br />
